...
# 1 point = $0.01; redeem only in multiples of 500; max 50% of order value
point_value = 0.01
...
'''
    ...
    try:
        ...
        # Fallback: apply only the tier discount
        tier_rates = {"Silver": 0.00, "Gold": 0.10, "Platinum": 0.15}
        tier_rate = tier_rates.get(tier, 0.0)
        ...
        fallback = {
            ...
            "tier": tier,
            "product_category": product_category,
            "note": f"Code Interpreter unavailable ({str(e)}); applied tier discount only",
        }
